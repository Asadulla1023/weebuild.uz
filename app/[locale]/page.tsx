        ...
        <div className={styles.modalContact}>
          ...
          >
            ...
            >
              ...
              >
                <path
                  d="M34.5026 0.210407L1.72767 13.2438C-0.50908 14.1702 -0.49614 15.457 1.31729 16.0308L9.73192 18.7377L29.2009 6.07038C30.1215 5.49277 30.9626 5.80349 30.2712 6.43639L14.4975 21.1168H14.4938L14.4975 21.1187L13.917 30.0631C14.7674 30.0631 15.1426 29.6608 15.6196 29.1862L19.7067 25.0876L28.2082 31.5633C29.7758 32.4536 30.9016 31.9961 31.2916 30.0669L36.8724 2.94404C37.4436 0.582136 35.998 -0.487299 34.5026 0.210407V0.210407Z"
                  fill="white"
                />
              </svg>
            </div>
            <div
              onClick={() => {
                window.open(
                  "https://www.instagram.com/weebuild_official/",
                  "_blank"
                );
              }}
              style={
          ...
          <button
            className={
              modal === false
                ? styles.contact
                : `${styles.contact} ${styles.noneAnimation}`
            }
            style={
              modal === true
                ? {
          ...
          >
            {modal === false ? (
              ...
              >
                <path
                  d="M24.7223 2.0332L2.0332 24.7223M2.0332 2.0332L24.7223 24.7223"
                  stroke="#E6E6E6"
                  stroke-width="4"
